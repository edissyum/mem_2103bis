...
// EDISSYUM - NCH01 Module formulaire SVE
$app->post('/doctypesSVE', Doctype\controllers\DoctypeController::class . ':getSVEDoctypes');
// END EDISSYUM - NCH01

// EDISSYUM - NCH01 Addulact Démarches Simplifiées
$app->post('/demarcheSimplifiee', \Resource\controllers\ResController::class . ':handleWebHook');
// END EDISSYUM - NCH01

// EDISSYUM - NCH01 Rajout de l'export PESv2 dans la recherche
$app->post('/pesv2', \Action\controllers\ActionMethodController::class . ':pesv2');
// END EDISSYUM - NCH01

$app->get('/parameters/nextcloud/check', \Parameter\controllers\ParameterController::class . ':check'); // EDISSYUM - AMO01 - One_line - Rajout d'une option -> mettre PJ dans mail via liens éphémères

// EDISSYUM - NCH01 Récupération des documents liés à un contact pour Open-Capture
$app->get('/resources/getByContact/{id}', \Contact\controllers\ContactController::class . ':getResourcesByContactId');
// END EDISSYUM - NCH01

// EDISSYUM - NCH01 Récupération d'un document par numéro de chrono
$app->post('/resources/getByChrono', \Resource\controllers\ResController::class . ':getResourcesByChrono');
// END EDISSYUM - NCH01

// EDISSYUM - NCH01 Récupération d'un groupement de contact par libellé
$app->post('/getContactsGroupsByLabel', \Contact\controllers\ContactGroupController::class . ':getByLabel');
// END EDISSYUM - NCH01

// EDISSYUM - NCH01 Fenetre de recherche de contacts
$app->get('/searchContactsTemplates', \Search\controllers\SearchTemplateController::class . ':getContacts');
$app->post('/searchContacts', \Search\controllers\SearchController::class . ':getContacts');
$app->get('/searchContacts/configuration', \Search\controllers\SearchController::class . ':getConfigurationContacts');
// END EDISSYUM - NCH01

// EDISSYUM - PYB01 Ajout du connecteur Pastell
$app->put('/users/{userId}/externalId', \User\controllers\UserController::class . ':updateExternalIdByUserId');
// END EDISSYUM - PYB01

// EDISSYUM - NCH01 Rajout d'une route pour récupérer les informations d'un utilisateur
$app->get('/users/getByUserId/{userId}', \User\controllers\UserController::class . ':getUserByUserId');
// END EDISSYUM - NCH01

// EDISSYUM - EME01 Ajout d'une fenêtre pour administrer la recherche des dossiers
$app->get('/searchFolders', \Folder\controllers\FolderController::class . ':getConfiguration');
// END EDISSYUM - EME01

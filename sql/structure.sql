...
(
  ...
  title text DEFAULT NULL::text, -- EDISSYUM - NCH01 Fix taille de l'objet d'une PJ
...
(
    ...
    filtrable boolean NOT NULL DEFAULT FALSE, -- EDISSYUM NCH01 - Fenetre de recherche de contacts
...
(
    ...
    signed_by_default BOOLEAN DEFAULT FALSE,

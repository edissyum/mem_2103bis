...
INSERT INTO contacts_parameters (id, identifier, mandatory, filling, searchable, displayable, filtrable) VALUES (1, 'civility', false, false, false, false, true); -- EDISSYUM NCH01 - Fenetre de recherche de contacts | Ajout de filtrable et VALUES
INSERT INTO contacts_parameters (id, identifier, mandatory, filling, searchable, displayable, filtrable) VALUES (2, 'firstname', false, true, true, true, false); -- EDISSYUM NCH01 - Fenetre de recherche de contacts | Ajout de filtrable et VALUES
INSERT INTO contacts_parameters (id, identifier, mandatory, filling, searchable, displayable, filtrable) VALUES (3, 'lastname', true, true, true, true, false); -- EDISSYUM NCH01 - Fenetre de recherche de contacts | Ajout de filtrable et VALUES
INSERT INTO contacts_parameters (id, identifier, mandatory, filling, searchable, displayable, filtrable) VALUES (4, 'company', true, false, true, true, false); -- EDISSYUM NCH01 - Fenetre de recherche de contacts | Ajout de filtrable et VALUES
INSERT INTO contacts_parameters (id, identifier, mandatory, filling, searchable, displayable, filtrable) VALUES (5, 'department', false, false, false, false, false); -- EDISSYUM NCH01 - Fenetre de recherche de contacts | Ajout de filtrable et VALUES
INSERT INTO contacts_parameters (id, identifier, mandatory, filling, searchable, displayable, filtrable) VALUES (6, 'function', false, false, false, false, true); -- EDISSYUM NCH01 - Fenetre de recherche de contacts | Ajout de filtrable et VALUES
INSERT INTO contacts_parameters (id, identifier, mandatory, filling, searchable, displayable, filtrable) VALUES (7, 'addressNumber', false, false, true, true, false); -- EDISSYUM NCH01 - Fenetre de recherche de contacts | Ajout de filtrable et VALUES
INSERT INTO contacts_parameters (id, identifier, mandatory, filling, searchable, displayable, filtrable) VALUES (8, 'addressStreet', false, true, true, true, false); -- EDISSYUM NCH01 - Fenetre de recherche de contacts | Ajout de filtrable et VALUES
INSERT INTO contacts_parameters (id, identifier, mandatory, filling, searchable, displayable, filtrable) VALUES (9, 'addressAdditional1', false, false, false, false, false); -- EDISSYUM NCH01 - Fenetre de recherche de contacts | Ajout de filtrable et VALUES
INSERT INTO contacts_parameters (id, identifier, mandatory, filling, searchable, displayable, filtrable) VALUES (10, 'addressAdditional2', false, false, false, false, false); -- EDISSYUM NCH01 - Fenetre de recherche de contacts | Ajout de filtrable et VALUES
INSERT INTO contacts_parameters (id, identifier, mandatory, filling, searchable, displayable, filtrable) VALUES (11, 'addressPostcode', false, true, true, true, false); -- EDISSYUM NCH01 - Fenetre de recherche de contacts | Ajout de filtrable et VALUES
INSERT INTO contacts_parameters (id, identifier, mandatory, filling, searchable, displayable, filtrable) VALUES (12, 'addressTown', false, true, true, true, false); -- EDISSYUM NCH01 - Fenetre de recherche de contacts | Ajout de filtrable et VALUES
INSERT INTO contacts_parameters (id, identifier, mandatory, filling, searchable, displayable, filtrable) VALUES (13, 'addressCountry', false, false, false, false, false); -- EDISSYUM NCH01 - Fenetre de recherche de contacts | Ajout de filtrable et VALUES
INSERT INTO contacts_parameters (id, identifier, mandatory, filling, searchable, displayable, filtrable) VALUES (14, 'email', false, true, false, false, false); -- EDISSYUM NCH01 - Fenetre de recherche de contacts | Ajout de filtrable et VALUES
INSERT INTO contacts_parameters (id, identifier, mandatory, filling, searchable, displayable, filtrable) VALUES (15, 'phone', false, true, false, false, false); -- EDISSYUM NCH01 - Fenetre de recherche de contacts | Ajout de filtrable et VALUES
INSERT INTO contacts_parameters (id, identifier, mandatory, filling, searchable, displayable, filtrable) VALUES (16, 'notes', false, false, false, false, false); -- EDISSYUM NCH01 - Fenetre de recherche de contacts | Ajout de filtrable et VALUES
INSERT INTO contacts_parameters (id, identifier, mandatory, filling, searchable, displayable, filtrable) VALUES (17, 'sector', false, false, false, false, false); -- EDISSYUM NCH01 - Fenetre de recherche de contacts | Ajout de filtrable et VALUES
...
INSERT INTO notifications (notification_sid, notification_id, description, is_enabled, event_id, notification_mode, template_id, diffusion_type, diffusion_properties, attachfor_type, attachfor_properties) VALUES (100, 'QUOTA', 'Alerte lorsque le quota est dépassé', 'Y', 'user_quota', 'EMAIL', 1049, 'user', 'superadmin', NULL, NULL); -- EDISSYUM - NCH01 Fix notification USER QUOTA | Remplacer 110 par 1049
...
INSERT INTO parameters (id, description, param_value_string, param_value_int, param_value_date) VALUES ('homepage_message', '', '<p><span style="font-size: 14pt;">Bienvenue sur <strong>MEM Courrier 21.03</strong> </span><br /><span style="font-size: 14pt;">Suivez le <a title="notre guide de visite" href="https://docs.maarch.org/" target="_blank" rel="noopener"><span style="color: #ED8022;"><strong>guide de visite en ligne</strong></span></a></span></p>', NULL, NULL); -- EDISSYUM - NCH01 Changement du nom d'application
...
INSERT INTO parameters (id, description, param_value_string, param_value_int, param_value_date) VALUES ('contactsConfidentiality', 'Gestion de la confidentialité des contacts','{"basic": {"customId": "", "entitiesAllowed": "", "hiddenFields": "email, phone, address"}, "advanced": {"customId": "", "entitiesAllowed": "", "hiddenFields": "email, phone, address, annotations"}}', NULL, NULL); -- EDISSYUM - NCH01 Rajout de la confidentialité des contacts
INSERT INTO parameters (id, description, param_value_string, param_value_int, param_value_date) VALUES ('showFoldersByDefault', 'Si activé (1), afficher les dossiers ouverts par defaut sinon (0)', NULL, 0, NULL); -- EDISSYUM - EME01 Ajout d'une fenêtre pour administrer la recherche des dossiers
...
INSERT INTO priorities (id, label, color, delays, "order") VALUES ('poiuytre1357nbvc', 'Normal', '#5E952D', 30, 1);
...
<tbody>
<tr>
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; text-align: left; background-color: #5E952D; color: white;">R&eacute;f&eacute;rence</th>
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; text-align: left; background-color: #5E952D; color: white;">Origine</th>
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; text-align: left; background-color: #5E952D; color: white;">Emetteur</th>
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; text-align: left; background-color: #5E952D; color: white;">Date</th>
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; text-align: left; background-color: #5E952D; color: white;">Objet</th>
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; text-align: left; background-color: #5E952D; color: white;">Type</th>
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; text-align: left; background-color: #5E952D; color: white;">&nbsp;</th>
</tr>
<tr>
...
<td style="border: 1px solid #ddd; padding: 8px; text-align: right;"><a style="text-decoration: none; background: #5E952D; padding: 5px; color: white; -webkit-box-shadow: 6px 4px 5px 0px rgba(0,0,0,0.75); -moz-box-shadow: 6px 4px 5px 0px rgba(0,0,0,0.75); box-shadow: 6px 4px 5px 0px rgba(0,0,0,0.75);" href="[res_letterbox.linktodetail]" name="detail">D&eacute;tail</a> <a style="text-decoration: none; background: #5E952D; padding: 5px; color: white; -webkit-box-shadow: 6px 4px 5px 0px rgba(0,0,0,0.75); -moz-box-shadow: 6px 4px 5px 0px rgba(0,0,0,0.75); box-shadow: 6px 4px 5px 0px rgba(0,0,0,0.75);" href="[res_letterbox.linktodoc]" name="doc">Afficher</a></td>
</tr>
</tbody>
</table>
<p>&nbsp;</p>
...
<tr>
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; text-align: left; background-color: #5E952D; color: white;">R&eacute;f&eacute;rence</th>
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; text-align: left; background-color: #5E952D; color: white;">Num</th>
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; text-align: left; background-color: #5E952D; color: white;">Date</th>
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; text-align: left; background-color: #5E952D; color: white;">Objet</th>
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; text-align: left; background-color: #5E952D; color: white;">Note</th>
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; text-align: left; background-color: #5E952D; color: white;">Contact</th>
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; text-align: left; background-color: #5E952D; color: white;">&nbsp;</th>
</tr>
<tr>
<td style="border: 1px solid #ddd; padding: 8px;">[res_letterbox.res_id]</td>
...
INSERT INTO tiles (id, user_id, type, view, "position", color, parameters) VALUES (1, 21, 'basket', 'summary', 3, '#ED8022#A5DA7', '{"groupId": 1, "basketId": 1}');
INSERT INTO tiles (id, user_id, type, view, "position", color, parameters) VALUES (5, 16, 'myLastResources', 'list', 0, '#A5DA7', '{"groupId": 2, "basketId": 3}');
...
INSERT INTO tiles (id, user_id, type, view, "position", color, parameters) VALUES (12, 5, 'basket', 'list', 0, '#A5DA7', '{"groupId": 8, "basketId": 9}');
INSERT INTO tiles (id, user_id, type, view, "position", color, parameters) VALUES (13, 4, 'myLastResources', 'list', 0, '#A5DA7', '{"groupId": 2, "basketId": 3}');
...
INSERT INTO tiles (id, user_id, type, view, "position", color, parameters) VALUES (16, 17, 'basket', 'chart', 1, '#A5DA7', '{"groupId": 4, "basketId": 15, "chartMode": "doctype", "chartType": "pie"}');

...
if (!defined('_VERSION_BASE_AND_XML_BASEVERSION_NOT_MATCH')) {
    define('_VERSION_BASE_AND_XML_BASEVERSION_NOT_MATCH', 'Attention: Le modèle de données de MEM doit être mis à jour...'); // EDISSYUM - NCH01 Changement du nom d'application
}
...
if (!defined('_WELCOME')) {
    define('_WELCOME', 'Bienvenue sur MEM Courrier !'); // EDISSYUM - NCH01 Changement du nom d'application
}
...
if (!defined('_APPS_COMMENT')) {
    define('_APPS_COMMENT', 'Application MEM'); // EDISSYUM - NCH01 Changement du nom d'application
}
...
if (!defined('_STANDARD_LOGIN')) {
    define('_STANDARD_LOGIN', 'Authentification MEM'); // EDISSYUM - NCH01 Changement du nom d'application
}
...
if (!defined('_UPDATE_DESC_INSTALL')) {
    define('_UPDATE_DESC_INSTALL', 'Procédure de mise à jour de MEM Courrier (versions mineures uniquement)'); // EDISSYUM - NCH01 Changement du nom d'application
}

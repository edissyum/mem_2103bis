...
class EntityControllerTest extends TestCase
{
    ...
    public function testCreate()
    {
        ...
        $aArgs = [
            ...
            'entity_type'       => 'Service',
            'email'             => 'marseille@isTheBest.fr',
            'addressNumber'    => '1',
            'addressStreet'    => 'avenue du Velodrome',
            'addressPostcode'  => '13000',
            'addressTown'      => 'MARSEILLE',
        ];
    ...
    public function testUpdate()
    {
        ...
        $aArgs = [
            ...
            'email'             => 'carpentras@isTheBest2.fr',
            'addressNumber'    => '2',
            'addressStreet'    => 'avenue du Velodrome',
            'addressPostcode'  => '13000',
            'addressTown'      => 'MARSEILLE',
    ...
    public function testGetDetailledById()
    {
        ...
        $this->assertSame('carpentras@isTheBest2.fr', $responseBody['entity']['email']);
        $this->assertSame('2', $responseBody['entity']['addressNumber']);
        $this->assertSame('avenue du Velodrome', $responseBody['entity']['addressStreet']);
        $this->assertSame('13000', $responseBody['entity']['addressPostcode']);
        $this->assertSame('MARSEILLE', $responseBody['entity']['addressTown']);

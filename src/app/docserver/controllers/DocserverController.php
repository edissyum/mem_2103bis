...
class DocserverController
{
    ...
    public static function createPathOnDocServer(array $args)
    {
        ...
        if (!is_dir($yearPath)) {
            ...
            umask(0022);
            chmod($yearPath, 0775); // EDISSYUM - PyB01 Fix docservers rights for VPS
        }
        ...
        if (!is_dir($monthPath)) {
            ...
            umask(0022);
            chmod($monthPath, 0775); // EDISSYUM - PyB01 Fix docservers rights for VPS
        }
    ...
    public static function getNextFileNameInDocServer(array $aArgs)
    {
        ...
        if ($filesNb == 0) {
            ...
            if (!mkdir($zeroOnePath, 0770)) {
                ...
                umask(0022);
                chmod($zeroOnePath, 0775); // EDISSYUM - PyB01 Fix docservers rights for VPS
            ...
            if ($filesNbBis >= 1000) { //If number of files >= 1000 then creates a new subdirectory
                ...
                if (!mkdir($zeroNumberPath, 0770)) {
                    ...
                    umask(0022);
                    chmod($zeroNumberPath, 0775); // EDISSYUM - PyB01 Fix docservers rights for VPS
    ...
    public static function copyOnDocServer(array $aArgs)
    {
        ...
        if (!is_dir($aArgs['destinationDir'])) {
            ...
            umask(0022);
            chmod($aArgs['destinationDir'], 0775); // EDISSYUM - PyB01 Fix docservers rights for VPS
        }
        ...
        umask(0022);
        chmod($aArgs['destinationDir'] . $aArgs['fileDestinationName'], 0775); // EDISSYUM - PyB01 Fix docservers rights for VPS

...
class EntityFolderModelAbstract
{
    ...
    public static function getEntitiesByFolderId(array $args)
    {
        ...
        $entitiesFolder = DatabaseModel::select([
            ...
            'where'     => ['folder_id = ?', 'entities_folders.entity_id is not null', 'keyword is null', 'entity_label is not null'], // EDISSYUM - EME01  Ajout d'une fenêtre pour administrer la recherche des dossiers | Ajouter 'entity_label is not null' dans le 'where'
            'data'      => [$args['folder_id']]
        ]);

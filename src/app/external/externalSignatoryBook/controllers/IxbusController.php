...
{
    public static function getInitializeDatas($config, $resId) // EDISSYUM - NCH01 IXBUS : Selection automatique du modèle de circuit | Ajout de $resId
    {
        ...
        // EDISSYUM - NCH01 IXBUS : Selection automatique du modèle de circuit
        $title = '';
        if (isset($config['data']['autoSelectModelRules'])) {
            foreach ($config['data']['autoSelectModelRules'] -> rules as $modelElements) {
        ...
        // END EDISSYUM - NCH01
        return ['natures' => $curlResponse['response']['payload'], 'modelTitle' => $title]; // EDISSYUM - NCH01 IXBUS : Selection automatique du modèle de circuit | Ajout de 'modelTitle'
    }

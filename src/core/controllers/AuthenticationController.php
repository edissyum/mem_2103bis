...
class AuthenticationController
{
    ...
    private static function ldapConnection(array $args)
    {
        ...
        foreach ($ldapConfigurations->config->ldap as $ldapConfiguration) {
            ...
            // END EDISSYUM - NCH01
//          EDISSYUM - NCH01 LDAP - Ne pas mettre de \ après le prefix Commenter cette ligne  $ldapLogin = (!empty($prefix) ? $prefix . '\\' . $login : $login);
...
//        \phpCAS::setDebug(); EDISSYUM - NCH01 Suppression fonction PHP CAS
...
//        \phpCAS::setDebug(); EDISSYUM - NCH01 Suppression fonction PHP CAS
        ...
        // $logoutUrl = \phpCAS::getServerLogoutURL(); LIGNE À COMMENTER
        // END EDISSYUM - EME01

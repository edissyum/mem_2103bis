...
define("_NOTIFICATIONS_FORGOT_PASSWORD_SUBJECT", "[MEM Courrier] Demande de réinitialisation de mot de passe"); // EDISSYUM - NCH01 Changement du nom d'application
define("_NOTIFICATIONS_FORGOT_PASSWORD_BODY", "Bonjour,<br/><br/>Vous avez demandé à retrouver le mot de passe d'accès à votre compte MEM Courrier.<br/><br/>Pour modifier votre mot de passe, merci de bien vouloir cliquer sur le lien ci-dessous :<br/><br/>"); // EDISSYUM - NCH01 Changement du nom d'application
...
define("_NOTIFICATIONS_USER_CREATION_SUBJECT", "[MEM Courrier] Activer votre compte utilisateur");// EDISSYUM - NCH01 Changement du nom d'application
define("_NOTIFICATIONS_USER_CREATION_BODY", "Bienvenue,<br/><br/>Vous disposez maintenant d'un compte dans l'application de gestion électronique de courrier MEM Courrier.<br/><br/>Pour vous connecter et définir votre mot de passe, merci de bien vouloir cliquer sur le lien ci-dessous :<br/><br/>"); // EDISSYUM - NCH01 Changement du nom d'application

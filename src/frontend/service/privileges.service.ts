...
export class PrivilegeService {
    ...
    private administrations: administration[] = [
        ...
        {
            'id': 'admin_search_folders',
            'label': 'lang.folders',
            'comment': 'lang.foldersAdministration',
            'route': '/administration/folders',
            'unit': 'production',
            'style': 'fas fa-folder-plus',
            'angular': true,
            'hasParams': false
        },
        // END EDISSYUM - EME01
    ...
    private privileges: privilege[] = [
        ...
        {
            'id': 'notes_restriction',
            'label': 'Restreindre par défaut les annotations à votre entité',
            'comment': 'Restreindre par défaut les annotations à votre entité',
            'unit': 'notes'
        },
        // END EDISSYUM - NCH01
        // EDISSYUM - NCH01 Rajout de la confidentialité des contacts
        {
            'id': 'view_confidential_contact',
            'label': 'Visualiser les coordonnées confidentielles d\'un contact',
            'comment': 'Visualiser les coordonnées confidentielles d\'un contact',
            'unit': 'application'
        },
        {
            'id': 'view_confidential_contact_advanced',
            'label': 'Visualiser les coordonnées confidentielles d\'un contact avancées',
            'comment': 'Visualiser les coordonnées confidentielles d\'un contact avancées',
            'unit': 'application'
        },
        // END EDISSYUM - NCH01
    ];
    ...
    private menus: menu[] = [
        ...
        {
            'id': 'view_contacts',
            'label': 'Visualiser les contacts sans droits d\'administration',
            'comment': 'Visualiser les contacts sans droits d\'administration',
            'route': '/administration/contacts',
            'style': 'fa fa-address-book',
            'unit': 'application',
            'angular': true,
        ...
        {
            'id': 'admin_search_contacts',
            'label': 'lang.searchContactAdvanced',
            'comment': 'lang.searchContactAdvanced',
            'route': '/searchContacts',
            'style': 'fa fa-id-badge',
            'unit': 'application',
            'angular': true,
            'shortcut': true
        }

...
export class DocumentViewerComponent implements OnInit, OnDestroy {
    ...
    @Input() realUserId: string = ''; // EDISSYUM - NCH01 Fix pour permettre la modification d'un courrier départ si le typist est égal à l'utilisateur connecté
        ...
        return new Promise((resolve, reject) => {
            this.http.get(`../rest/resources/${this.resId}/versionsInformations`).pipe(
                ...
                tap((data: any) => {
                    ...
                    if (data.information.category_id === 'outgoing' && (data.information.typist === parseInt(this.realUserId) || data.information.dest_user === parseInt(this.realUserId))) {
                        this.editMode = true;
                    }
                    // END EDISSYUM - NCH01

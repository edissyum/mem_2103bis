...
import { ExportPESv2ActionComponent } from './export-pesv2-action/export-pesv2-action.component'; // EDISSYUM - NCH01 Module export PESV2
...
export class ActionsService implements OnDestroy {
    ...
    exportPESV2Action(options: any = null) {
        const dialogRef = this.dialog.open(ExportPESv2ActionComponent, {
            panelClass: 'maarch-modal',
            autoFocus: false,
            disableClose: true,
            data: this.setDatasActionToSend()

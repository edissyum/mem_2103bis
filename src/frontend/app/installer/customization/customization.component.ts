...
export class CustomizationComponent implements OnInit {
    ...
    constructor(
        ...
        this.stepFormGroup = this._formBuilder.group({
            ...
            loginMessage: [`<span style="color:#5E952D"><strong>Découvrez votre application via</strong></span>&nbsp;<a title="le guide de visite" href="https://docs.maarch.org/gitbook/html/MaarchCourrier/${environment.VERSION.split('.')[0] + '.' + environment.VERSION.split('.')[1]}/guu/home.html" target="_blank"><span style="color:#ED8022;"><strong>le guide de visite en ligne</strong></span></a>`],
            homeMessage: ['<p>D&eacute;couvrez <strong>Maarch Courrier 21.03</strong> avec <a title="notre guide de visite" href="https://docs.maarch.org/" target="_blank"><span style="color:#ED8022;"><strong>notre guide de visite en ligne</strong></span></a>.</p>'],

...
import { ContactsCriteriaSearchService } from '@service/contactsCriteriaSearch.service'; // EDISSYUM - NCH01 Fenetre de recherche de contacts
...
import { BluewayParaphComponent } from './actions/send-external-signatory-book-action/blueway-paraph/blueway-paraph.component'; // EDISSYUM - PYB01 Ajout du connecteur Blueway
import { PastellParaphComponent } from './actions/send-external-signatory-book-action/pastell-paraph/pastell-paraph.component'; // EDISSYUM - PYB01 Ajout du connecteur Pastell
...
import { ExportPESv2ActionComponent } from './actions/export-pesv2-action/export-pesv2-action.component'; // EDISSYUM - NCH01 Module export PESV2
...
import { ContactFilterToolComponent } from './contact/search/filter-tool/contact-filter-tool.component'; // EDISSYUM - NCH01 Fenetre de recherche de contacts
...
import { ContactSearchResultListComponent } from './contact/search/result-list/contact-search-result-list.component'; // EDISSYUM - NCH01 Fenetre de recherche de contacts
...
@NgModule({
    ...
    declarations: [
        ...
        FilterToolComponent,
        ContactFilterToolComponent, // EDISSYUM - NCH01 Fenetre de recherche de contacts
        PanelListComponent,
        SearchComponent,
        ContactSearchComponent, // EDISSYUM - NCH01 Fenetre de recherche de contacts
        SearchResultListComponent,
        ContactSearchResultListComponent, // EDISSYUM - NCH01 Fenetre de recherche de contacts
        AboutUsComponent,
        ...
        BluewayParaphComponent, // EDISSYUM - PYB01 Ajout du connecteur Blueway
        PastellParaphComponent, // EDISSYUM - PYB01 Ajout du connecteur Pastell
        IParaphComponent,
        ...
        ExportPESv2ActionComponent // EDISSYUM - NCH01 Module export PESV2
    ],
    exports : [
        SharedModule
    ],
    ...
    providers: [
        ...
        ContactsCriteriaSearchService, // EDISSYUM - NCH01 Fenetre de recherche de contacts
        FoldersService,
        ActionsService,
        PrivilegeService,
        ActionPagesService,

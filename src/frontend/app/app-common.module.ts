...
import { ContactsCriteriaToolComponent } from '@appRoot/contact/search/criteria-tool/contacts-criteria-tool.component'; // EDISSYUM - NCH01 Fenetre de recherche de contacts
...
@NgModule({
    ...
    declarations: [
        ...
        ContactsCriteriaToolComponent, // EDISSYUM - NCH01 Fenetre de recherche de contacts

...
@Component({
    selector: 'app-folders-administration',
    templateUrl: './folders-administration.component.html',
    styleUrls: ['./folders-administration.component.scss']
})

export class FoldersAdministrationComponent implements OnInit {
    ...
    async ngOnInit(): Promise<void> {
        this.headerService.setHeader(this.translate.instant('lang.foldersAdministration'));
    ...
    saveTemplate() {
        ...
        this.http.put('../rest/configurations/admin_search_folders', { 'listDisplay': objToSend, 'listEvent': this.selectedListEvent, 'list_event_data': this.selectedProcessTool })
            .subscribe(() => {
                this.displayedSecondaryDataClone = JSON.parse(JSON.stringify(this.displayedSecondaryData));

...
import { ContactSearchAdministrationComponent } from './contact/search/contact-search-administration.component'; // EDISSYUM - NCH01 Fenetre de recherche de contacts
...
import { FoldersAdministrationComponent } from './folders/folders-administration.component'; // EDISSYUM - EME01 Ajout d'une fenêtre pour administrer la recherche des dossiers
...
@NgModule({
    imports: [
        RouterModule.forChild([
            ...
            { path: 'administration/contacts/search', canActivate: [AppGuard], component: ContactSearchAdministrationComponent }, // EDISSYUM - NCH01 Fenetre de recherche de contacts
            ...
            { path: 'administration/folders', canActivate: [AppGuard], component: FoldersAdministrationComponent }, // EDISSYUM - EME01 Ajout d'une fenêtre pour administrer la recherche des dossiers
        ]),
    ],
    exports: [
        RouterModule

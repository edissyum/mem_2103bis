...
export class ContactsParametersAdministrationComponent implements OnInit {
    ...
    displayedColumns = ['label', 'mandatory', 'filling', 'searchable', 'displayable', 'filtrable']; // EDISSYUM - NCH01 Fenetre de recherche de contacts | ajout de searchContactFilter

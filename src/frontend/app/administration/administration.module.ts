...
import { FoldersAdministrationComponent} from '@appRoot/administration/folders/folders-administration.component';  // EDISSYUM - EME01 Ajout d'une fenêtre pour administrer la recherche des dossiers
...
@NgModule({
    ...
    declarations: [
        ...
        ContactSearchAdministrationComponent, // EDISSYUM - NCH01 Fenetre de recherche de contacts
        ...
        FoldersAdministrationComponent,  // EDISSYUM - EME01 Ajout d'une fenêtre pour administrer la recherche des dossiers
    ],
    entryComponents: [
        AccountLinkComponent,
        BasketAdministrationGroupListModalComponent,

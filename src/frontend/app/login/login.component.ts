...
export class LoginComponent implements OnInit {
    ...
    showPassword: boolean = false; // EDISSYUM - NCH01 Ajout d'une option pour afficher le mot de passe
    ...
    ngOnInit(): void {
        ...
        /* EDISSYUM - NCH01 Amélioration de l'affichage de version sur l'écran de connexion */
        ...
        //     this.applicationVersion = environment.VERSION.concat(' ', mode);
        // } else {
        //     this.applicationVersion = environment.VERSION;
        // }
        /* END EDISSYUM - NCH01 */
